...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@Debug/Profiler/dump.html.twig", "/Users/robiulhasan/Project/symfony-login-registration-system/vendor/symfony/debug-bundle/Resources/views/Profiler/dump.html.twig");
    }
}
