...
return [
    ...
    [ // $staticRoutes
        ...
        '/taskt' => [
            [['_route' => 'app_taskt', '_controller' => 'App\\Controller\\TasktController::index'], null, null, null, false, false, null],
            [['_route' => 'create_task', '_controller' => 'App\\Controller\\TasktController::createTask'], null, null, null, false, false, null],
        ],
        '/login' => [[['_route' => 'login'], null, ['GET' => 0], null, false, false, null]],
    ],
    [ // $regexpList
        0 => '{^(?'
                .'|/_(?'
    ...
    [ // $dynamicRoutes
        ...
        219 => [[['_route' => 'app_task_show', '_controller' => 'App\\Controller\\TaskController::show'], ['id'], ['GET' => 0], null, false, true, null]],
        232 => [[['_route' => 'app_task_edit', '_controller' => 'App\\Controller\\TaskController::edit'], ['id'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        240 => [
